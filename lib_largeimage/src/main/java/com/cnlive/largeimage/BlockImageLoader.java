...
import com.cnlive.largeimage.factory.BitmapDecoderFactory;
...
public class BlockImageLoader {
    ...
    public void stopLoad() {
        if (mLoadData != null) {
            ...
            if (mLoadData!=null&&mLoadData.thumbnailBlockData!=null&&mLoadData.thumbnailBlockData.bitmap!=null){
                mLoadData.thumbnailBlockData.bitmap.recycle();
                mLoadData.thumbnailBlockData.bitmap=null;
            }
            ...
            if ( mLoadData.mDecoder!=null)
                mLoadData.mDecoder.recycle();
        }
    }
